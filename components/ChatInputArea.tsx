      ...
      <div className="flex items-end space-x-2">
        ...
        {canRestart && !isLoading && onRestartGeneration && (
          <button
            ...
            className="px-4 py-3 text-white font-semibold rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-800 bg-yellow-600 hover:bg-yellow-500 focus:ring-yellow-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors h-full flex items-center justify-center"
