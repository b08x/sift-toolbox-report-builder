...
class PersistenceServiceTest < Minitest::Test
  ...
  def test_update_analysis_report
    ...
    # Reload and verify
    analysis.refresh
    assert_equal "This is the complete SIFT analysis report with findings and conclusions.", analysis.generated_report_text
  end
  ...
  def test_save_assistant_message
    ...
    analysis = create_test_analysis
    grounding_sources = { "sources" => ["source1", "source2"] }
